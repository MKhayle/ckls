...
declare module '$env/static/private' {
	...
	export const EFC_10864_1592913036: string;
	...
	export const OpenXXApp: string;
	export const OpenXXDir: string;
	export const OpenXXDll: string;
	...
	export const XL_PRERELEASE: string;
